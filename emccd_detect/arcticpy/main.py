...
from emccd_detect.arcticpy.traps import TrapInstantCapture
from emccd_detect.arcticpy import util
from emccd_detect.arcticpy.main_utils import cy_clock_charge_in_one_direction
